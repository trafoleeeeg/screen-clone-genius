export default function FeaturesSection() {
  ...
  return <section className="pt-2 pb-20 px-4 sm:px-6 features-section-bg">
      <div className="container mx-auto max-w-5xl">
        {/* Section Title */}
        <div className="text-center mb-8 md:mb-12">
          <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-foreground leading-tight max-w-3xl mx-auto px-2 sm:px-4">Зарегестрируйтесь, чтобы зарабатывать на своем эксклюзивном контенте</h2>
        </div>

        {/* Features Grid */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 max-w-6xl mx-auto px-2 sm:px-4">
